...
then
  ...
  tmux send-keys -t beautiful:1.2 "sass --watch styles/horst/horst.scss:agile-de/static/css/bootstrap-horst.css" C-m
  tmux send-keys -t beautiful:1.3 "sass --watch styles/horst/horst.scss:agile-en/static/css/bootstrap-horst.css" C-m
